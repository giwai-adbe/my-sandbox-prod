...
## Environments
- Preview: https://main--my-sandbox-prod--giwai-adbe.aem.page/
- Live: https://main--my-sandbox-prod--giwai-adbe.aem.live/
...
1. Open the `my-sandbox-prod` directory in your favorite IDE and start coding :)
